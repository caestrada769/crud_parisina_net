...
namespace CrudParisina.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(ParisinaNetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar, string ordenActual, int? numpag, string filtroActual)
        {
            ...
            ViewData["FiltroCorreo"] = String.IsNullOrEmpty(ordenActual) ? "Correo" : "";
            switch (ordenActual)
            {
            ...
            //Retornamos la lista de categoías encontradas
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,IdRol,Correo,EstadoUsuario")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,IdRol,Correo,EstadoUsuario")] Usuario usuario)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ParisinaNetContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
